...
<script id="applyTabList-tmpl" type="text/x-jquery-tmpl">
	{{each(i,row) data}}
		<tr>
			...
			<td class="text-center">[{{= row.app.appCode}}] {{= row.app.appName}}</td>
			...
			<td class="text-center">
					C: {{= row.apply.cpuCount/100}}个，M: {{= CU.toMegaByteUnit(row.apply.memSize)}}，D: {{= CU.toMegaByteUnit(row.apply.diskSize)}}
			</td>
