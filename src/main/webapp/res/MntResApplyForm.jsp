...
<div class="main-box">
	...
	<div class="main-box-body clearfix">
		<form class="form-horizontal" role="form" id="formMntResApply">
			<div class="form-group">
				<label for="dataCenterId" class="col-lg-2 control-label">数据中心<font color="red">*</font>:</label>
				<div class="col-lg-5">
					<select type="text" name="dataCenterId" required class="form-control" id="dataCenterId" ></select>
				</div>
				<div class="col-lg-5">
			...
			<div class="form-group">
				<label for="resCenterId" class="col-lg-2 control-label">资源中心<font color="red">*</font>:</label>
				<div class="col-lg-5">
					<select type="text" name="resCenterId"  required class="form-control" id="resCenterId" ></select>
				</div>
				<div class="col-lg-5">
			...
			<div class="form-group">
				...
				<div class="col-lg-5">
					<input type="text" name="diskSize" required maxLength=8 class="form-control" id="diskSize" pattern="[0-9]{1,8}" placeholder="必填">
				</div>
				<div class="col-lg-5">
					<span>单位:G</span>
				</div>
