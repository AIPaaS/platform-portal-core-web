...
function queryDepInstance(id,pageNum){
	...
	$("#mod_pagination_box").html('<ul id="mod_sul_pagination" class="pagination-sm"></ul>');
	var pageSize = $("#mod_grid_pageSize").val();
	
	var ps = {pageNum:pageNum,pageSize:pageSize,depHistoryId:id,orders:"ID"};
