...
<script id="imgSvcTable-tmpl" type="text/x-jquery-tmpl">
	{{each(i,row) data}}
		<tr>
			<td class="text-center"><div title="{{= row.svc.svcCode}}">{{= row.svc.svcCode.substring(0,15)}}</div></td>
			<td class="text-center"><div title="{{= row.svc.svcName}}">{{= row.svc.svcName.substring(0,15)}}</div></td>
