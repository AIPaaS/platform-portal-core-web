		...
		<tr>
			...
			<td class="text-center">
				{{if !CU.isEmpty(row.totalRes)}}
					<font color='#cc0000'>C: {{= row.totalRes.cpuCount/100}}个，M: {{= CU.toMegaByteUnit(row.totalRes.memSize,false)}}，D: {{= CU.toMegaByteUnit(row.totalRes.diskSize,false)}}</td></font>
				{{/if}}
			<td class="text-center">
